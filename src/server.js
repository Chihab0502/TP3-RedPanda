...
import {getConfigNumber, getNumberWord, getDebug, getTimeOut, getTopic, getTypeMessage} from "./config/config.js";

const configNumber = getConfigNumber()
const typeMessage = getTypeMessage()
const topic = getTopic()
const debug = getDebug()
const numWord = getNumberWord()
